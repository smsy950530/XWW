...
<body>
	...
	<div class="content">
		...
		<div class="cont-inner">
			<ul>
				<li>旧密码：<input type="password" name="opassword" id="username" /></li>	
				<li>新密码：<input type="password" name="password" required="true" id="password" /></li>
				<li>确认新密码：<input type="password" name="passwordtoo" required="true" id="passwordtoo" onchange="check()"><span id="tishi"></span></li>
			</ul>
			<div class="cont-btn">
